...
- [実践 Git - 低レベルに知る Git](https://www.slideshare.net/youhei/git-12695573)
- [【翻訳】Gitをボトムアップから理解する](https://keijinsonyaban.blogspot.com/2011/05/git.html)

### 実装に関する話
-  [【mixi】ハンズオン: 内部構造を学びGitを自作できるようになろう！ ](https://youtu.be/-4rcs6SgT0o)
   - [shumon84/git-log](https://github.com/shumon84/git-log/)
